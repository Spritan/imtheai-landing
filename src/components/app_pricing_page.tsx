      ...
      tiers: [
        {
          ...
          features: ["5 Try-Ons/month", "Basic clothing items", "Community support", "Mobile app access"],
        },
        {
          name: "Basic",
          price: "$9",
          description: "Essential Virtual Try-On for individuals",
          features: ["50 Try-Ons/month", "Extended clothing catalog", "Email support", "Mobile & web access"],
        },
        {
          name: "Pro",
          price: "$29",
          description: "Advanced Virtual Try-On for professionals",
          features: ["Unlimited Try-Ons", "Full clothing catalog", "Priority support", "API access"],
        },
        {
          name: "Enterprise",
          price: "Custom",
          description: "Tailored Virtual Try-On solutions",
          features: ["Custom clothing catalog", "Dedicated account manager", "On-premise deployment", "White-label option"],
        },
        {
          name: "TerPrice",
          price: "$99",
          description: "Cutting-edge Virtual Try-On features",
          features: ["Unlimited Try-Ons", "Exclusive designer items", "24/7 priority support", "Custom AI model development"],
        },
      ],
    },
    aiPhotoshoot: {
      ...
      tiers: [
        {
          ...
          features: ["3 AI photos/month", "Basic backgrounds", "Community support", "Mobile app access"],
        },
        {
          name: "Basic",
          price: "$12",
          description: "Essential AI Photoshoot for individuals",
          features: ["30 AI photos/month", "Extended background library", "Email support", "Mobile & web access"],
        },
        {
          name: "Pro",
          price: "$39",
          description: "Advanced AI Photoshoot for professionals",
          features: ["100 AI photos/month", "Premium backgrounds", "Priority support", "Basic editing tools"],
        },
        {
          name: "Enterprise",
          price: "Custom",
          description: "Tailored AI Photoshoot solutions",
          features: ["Unlimited AI photos", "Custom backgrounds", "Dedicated account manager", "Advanced editing suite"],
        },
        {
          name: "TerPrice",
          price: "$129",
          description: "Cutting-edge AI Photoshoot features",
          features: ["Unlimited AI photos", "Exclusive artistic styles", "24/7 priority support", "Custom AI model development"],
        },
      ],
    },
  }
    ...
    <section className="w-full py-12 bg-gray-50">
      <div className="container px-4 md:px-6">
        ...
        >
          ...
          <p className="mt-4 text-gray-500 md:text-xl">Choose the perfect plan for your AI needs</p>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {services[activeService].tiers.map((tier, index) => (
              <motion.div
                key={tier.name}
