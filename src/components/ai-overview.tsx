        ...
        <div className="flex flex-col md:flex-row w-full gap-8 items-center flex-1 ">
          ...
          <div className="md:w-2/5  flex-1">
            <div className="flex flex-col items-center flex-1 mt-[50px] ">
              <h2 className="text-2xl font-bold text-center text-gray-900 mb-4 z-20 ">
                Generated Image
              </h2>
              <div className="relative w-[300px]  h-[600px]">
                <div className="p-8 mb-8  absolute w-[300px]">
                  {/*
                ...
                */}
                ...
                {/* Dress Selection */}
                <div className="absolute  w-[350px]  sm:right-[100px]  top-[490px] right-[-20px] sm:top-[350px]">
                  <h2 className="hidden sm:block text-xl font-bold text-gray-900 mb-4 ">
                    Choose a Dress
                  </h2>
                ...
                <div className="absolute  w-[135px] sm:w-[170px] right-[350px] left-[190px] top-[-20px]">
